...
*                     WITH UNIQUE KEY last_name first_name.
    ...
    TYPES tt_persons TYPE HASHED TABLE OF z10s_person_deep
                     WITH UNIQUE KEY last_name first_name.
...
*    DATA addresses TYPE tt_addresses.
    DATA addresses TYPE z10t_addresses.
...
*    DATA person TYPE st_person_deep.
    DATA person TYPE z10s_person_deep.
...
*    DATA persons TYPE tt_persons.
    DATA persons TYPE z10t_persons.
