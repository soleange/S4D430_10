CLASS zcl_10_structures DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_10_STRUCTURES IMPLEMENTATION.
...
*    DATA address TYPE st_address.
    DATA address TYPE z10s_address.
...
*    DATA person2 TYPE st_person_inc.
 DATA person2 TYPE z10s_person_inc.
